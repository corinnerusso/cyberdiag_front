...
CREATE TABLE `topic` (
  ...
  `topic_max_quote` int DEFAULT NULL,
  PRIMARY KEY (`topicId`)
...
INSERT INTO `topic` VALUES (1,'Sécurité des systèmes d\'informations',36),(2,'Sécurité du réseau',16),(3,'Facteur humain',16),(4,'Incidents et gestion de crise',14),(5,'Sujet PME 1',15),(6,'Sujet PME 2',20),(7,'Sujet PME 3',15);
