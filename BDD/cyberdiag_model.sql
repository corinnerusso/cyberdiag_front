...
CREATE TABLE `model` (
  ...
  PRIMARY KEY (`modelId`),
  KEY `FK_92e90f4525ad99419eaa9fcb9c7` (`companyCompanyId`),
  CONSTRAINT `FK_92e90f4525ad99419eaa9fcb9c7` FOREIGN KEY (`companyCompanyId`) REFERENCES `company` (`companyId`)
...
INSERT INTO `model` VALUES (1,'Questionnaire TPE',1),(2,'Questionnaire PME',2);
